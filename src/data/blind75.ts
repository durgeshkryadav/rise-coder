...
const blind75Data: Blind75Week[] = [
  {
    ...
    problems: [
      { id: 'b75-1', number: 1, title: 'Contains Duplicate', difficulty: 'Easy', time: 15, tag: 'Array', url: 'https://leetcode.com/problems/contains-duplicate/' },
      { id: 'b75-2', number: 2, title: 'Valid Anagram', difficulty: 'Easy', time: 15, tag: 'Array', url: 'https://leetcode.com/problems/valid-anagram/' },
      { id: 'b75-3', number: 3, title: 'Two Sum', difficulty: 'Easy', time: 15, tag: 'Array', url: 'https://leetcode.com/problems/two-sum/' },
      { id: 'b75-4', number: 4, title: 'Group Anagrams', difficulty: 'Medium', time: 30, tag: 'Array', url: 'https://leetcode.com/problems/group-anagrams/' },
      { id: 'b75-5', number: 5, title: 'Top K Frequent Elements', difficulty: 'Medium', time: 25, tag: 'Array', url: 'https://leetcode.com/problems/top-k-frequent-elements/' },
      { id: 'b75-6', number: 6, title: 'Encode and Decode Strings', difficulty: 'Medium', time: 25, tag: 'Array', url: 'https://leetcode.com/problems/encode-and-decode-strings/' },
      { id: 'b75-7', number: 7, title: 'Product of Array Except Self', difficulty: 'Medium', time: 30, tag: 'Array', url: 'https://leetcode.com/problems/product-of-array-except-self/' },
      { id: 'b75-8', number: 8, title: 'Longest Consecutive Sequence', difficulty: 'Medium', time: 30, tag: 'Array', url: 'https://leetcode.com/problems/longest-consecutive-sequence/' },
    ],
  },
  {
    week: 2,
    ...
    problems: [
      { id: 'b75-9', number: 9, title: 'Valid Parentheses', difficulty: 'Easy', time: 20, tag: 'Stack', url: 'https://leetcode.com/problems/valid-parentheses/' },
      { id: 'b75-10', number: 10, title: 'Valid Palindrome', difficulty: 'Easy', time: 15, tag: 'Two Pointers', url: 'https://leetcode.com/problems/valid-palindrome/' },
      { id: 'b75-11', number: 11, title: 'Merge Two Sorted Lists', difficulty: 'Easy', time: 20, tag: 'Linked List', url: 'https://leetcode.com/problems/merge-two-sorted-lists/' },
      { id: 'b75-12', number: 12, title: 'Best Time to Buy and Sell Stock', difficulty: 'Easy', time: 20, tag: 'Sliding Window', url: 'https://leetcode.com/problems/best-time-to-buy-and-sell-stock/' },
      { id: 'b75-13', number: 13, title: 'Invert Binary Tree', difficulty: 'Easy', time: 15, tag: 'Binary Tree', url: 'https://leetcode.com/problems/invert-binary-tree/' },
      { id: 'b75-14', number: 14, title: 'Lowest Common Ancestor of a Binary Search Tree', difficulty: 'Easy', time: 20, tag: 'Binary Search Tree', url: 'https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/' },
    ],
  },
  {
    week: 3,
